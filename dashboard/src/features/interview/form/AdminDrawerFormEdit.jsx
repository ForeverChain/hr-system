...
export default function AdminDrawerFormEdit({ id }) {
    ...
    const initialFormData = {
        candidateId: { value: edittingRowInfo?.candidateId?._id, error: null },
        hrOfficerId: { value: edittingRowInfo?.hr._id, error: null },
        talkingSkill: { value: edittingRowInfo?.resultId[0].talkingSkill, error: null },
        appearance: { value: edittingRowInfo?.resultId[0].appearance, error: null },
        disadvantage: { value: edittingRowInfo?.resultId[0].disadvantage, error: null },
        advantage: { value: edittingRowInfo?.resultId[0].advantage, error: null },
        skills: { value: edittingRowInfo?.resultId[0].skills, error: null },
    };

    const { onChangeWithoutEvent, onError, formState, setValueField } = useForm(initialFormData);
    ...
    function submitForm(e) {
        ...
        payload.append('hrOfficerId', formState?.hrOfficerId?.value);
            ...
            <div className='md:flex md:items-center mb-6'>
                ...
                <div className='md:w-2/3'>
                    <select
                        ...
                        id='candidateId'
                        name='candidateId'
                        onChange={(e) => onChangeWithoutEvent(e.target.value)}
            ...
            <div className='md:flex md:items-center mb-6'>
                ...
                <div className='md:w-2/3'>
                    <select
                        ...
                        name='hrOfficerId'
                        onChange={(e) => onChangeWithoutEvent(e.target.value)}
                        value={formState?.hrOfficerId?.value}
                    >
                        <option value=''>Сонгоорой...</option>
                        {hrList?.map((hr) => (
